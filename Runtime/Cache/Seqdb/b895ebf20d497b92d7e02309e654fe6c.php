...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录SeqDB Systerm</title>
        <link rel="stylesheet" type="text/css" href="/Public/Seqdb/css/login.css" media="all">
       	<link rel="stylesheet" type="text/css" href="/Public/Seqdb/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i>SeqDB Systerm</h3>
