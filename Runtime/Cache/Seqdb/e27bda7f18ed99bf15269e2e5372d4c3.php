<?php if (!defined('THINK_PATH')) exit();?><html lang="zh-CN">
    ...
    <div class="jumbotron">
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                <a class="btn btn-info pull-right" style="margin-top: 30px;" href="/index.php?s=/Sample/add" role="button">添加样本</a>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="datatable" class="table table-hover table-striped table-bordered " cellspacing="0" width="100%">
                        ...
                        <thead>
                            <tr><th class="text-center">样品编号</th><th class="text-center">样品类型</th><th class="text-center">样品名称</th><th class="text-center">样品来源</th><th class="text-center">样品描述</th><th class="text-center">核酸类型</th><th class="text-center">操作</th></tr>
                        </thead>
                        
                        <tbody class="text-center" >
                            <?php if(is_array($sample)): foreach($sample as $key=>$obj): ?><tr>
                                <td><?php echo ($obj['sampleid']); ?></td>
                                <td><?php echo ($obj['type']); ?></td>
                                <td><?php echo ($obj['name']); ?></td>
                                <td><?php echo ($obj['source']); ?></td>
                                <td><?php echo ($obj['description']); ?></td>
                                <td><?php echo ($obj['nucleic_acid']); ?></td>
                                <td><a href="/index.php?s=/Sample/detail/sid/<?php echo ($obj["id"]); ?>">详情</a> <?php if(($obj['operator']) == $uid): ?>| <a href="/index.php?s=/Sample/update/sid/<?php echo ($obj["id"]); ?>">修改</a> | <a href="/index.php?s=/Sample/del/sid/<?php echo ($obj["id"]); ?>">删除</a><?php endif; ?></td>
