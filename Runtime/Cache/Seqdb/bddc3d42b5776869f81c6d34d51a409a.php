<?php if (!defined('THINK_PATH')) exit();?><html lang="zh-CN">
    ...
    <div class="container">
        <div class="row">
        <div class="col-md-12">
            <a class="btn btn-primary btn-lg" style="margin-top: 30px;" href="/ot/index.php?s=/Data/index" role="button">返回数据列表</a>
        </div>
        <div class="col-md-12">
            <table id="datatable" class="table table-hover table-striped table-bordered " cellspacing="0" width="100%">
                ...
                <tbody class="text-center" >
                    ...
                    <?php else: ?>
                        <tr><td>样本编号</td><td><a href="<?php echo get_sampleinfo($data['sample_id']);?>">SampleID: <?php echo ($data['sample_id']); ?></a> </td></tr><?php endif; ?>
                    
                    <tr><td>样本编号</td><td>SampleID: <?php echo get_sampleinfo($data['sample_id']);?></td></tr>
        ...
        <div class="col-md-6">
            <a class="btn btn-primary" style="margin-top: 30px;" href="/ot/index.php?s=/Data/update/sid/<?php echo ($sample['id']); ?>" role="button" target="_blank">修改文库信息</a>
            <a class="btn btn-primary" style="margin-top: 30px; margin-left: 30px;" href="/ot/index.php?s=/Data/del/sid/<?php echo ($sample['id']); ?>" role="button" target="_blank">删除此文库</a>
            <a class="btn btn-primary" style="margin-top: 30px; margin-left: 30px;" href="/ot/index.php?s=/Data/index" role="button">返回文库列表</a>
        </div>
    </div>
