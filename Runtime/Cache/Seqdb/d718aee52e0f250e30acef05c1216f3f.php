<?php if (!defined('THINK_PATH')) exit();?><html lang="zh-CN">
    ...
    <div class="jumbotron">
        ...
        <div class="container">
            ...
            <div class="col-md-6">
                <a class="btn btn-info pull-right" style="margin-top: 30px;" href="/index.php?s=/Library/add" role="button" target="_blank">添加文库</a>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="datatable" class="table table-hover table-striped table-bordered " cellspacing="0" width="100%">
                        ...
                        <thead>
                            <tr><th class="text-center">文库编号</th><th class="text-center">样品编号</th><th class="text-center">试剂盒</th><th class="text-center">峰值(bp)</th><th class="text-center">浓度   ( Qbit 2.0 | qPCR )</th><th class="text-center">描述</th><th class="text-center">操作</th></tr>
                        </thead>
                        
                        <tbody class="text-center" >
                            <?php if(is_array($library)): foreach($library as $key=>$obj): ?><tr>
                                <td><?php echo ($obj['lib_id']); ?></td>
                                <?php if(($obj['sample_id']) == "none"): ?><td>样本未收录在本数据库</td>
                                <?php else: ?>
                                <td><a href="<?php echo get_sampleinfo($obj['sample_id']);?>"><?php echo ($obj['sample_id']); ?></a></td><?php endif; ?>
                                <td><?php echo ($obj['kit']); ?></td>
                                <td><?php echo ($obj['peak']); ?></td>
                                <td><?php echo ($obj['conc_qubit']); ?> (ng/uL) | <?php echo ($obj['conc_qpcr']); ?> (nM)</td>
                                <td><?php echo ($obj['description']); ?></td>
                                <td><a href="/index.php?s=/Library/detail/sid/<?php echo ($obj["id"]); ?>">详情</a> <?php if(($obj['operator']) == "is_login()"): ?>| <a href="/index.php?s=/Library/update/sid/<?php echo ($obj["id"]); ?>">修改</a> | <a href="/index.php?s=/Library/del/sid/<?php echo ($obj["id"]); ?>">删除</a><?php endif; ?></td>
